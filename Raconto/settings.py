"""
Django settings for Raconto project.
...
SECRET_KEY = 'django-insecure-++&y9)t(*r(oel1jlu!e))2xh^i*%_ffoj$4495)8k=9srn-*h'
...
WSGI_APPLICATION = 'Raconto.wsgi.application'
